...
<td class="justify-content-end">
  <?php if (auth()->user()->can('galleries.edit') || auth()->user()->can('galleries.delete')) : ?>
    <!-- Action Menu -->
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <?php if (auth()->user()->can('galleries.edit')) : ?>
        ...
        <?php if (auth()->user()->can('galleries.delete')) : ?>
          ...
          <li><a href="<?= url_to('gallery-delete', $gallery->id) ?>" class="dropdown-item" onclick="return confirm(<?= lang('Bonfire.deleteResource', [lang('Galleries.gallery')]) ?>)">
              <?= lang('Bonfire.delete') ?>
            </a>
          </li>
        <?php endif ?>
