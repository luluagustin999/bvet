...
class SearchProvider extends GalleriesModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('Galleries.galleries');
    }
    ...
    {
        return 'App\Modules\Galleries\Views\_search_list';
    }
}
