...
use App\Modules\Informasi\Veteriner\AlurPersyaratan\Models\AlurPersyaratanModel;

class SearchProvider extends AlurPersyaratanModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('AlurPersyaratan.alurpersyaratan');
    }
    ...
    {
        return ADMIN_AREA . '/alurpersyaratan';
    }
    ...
    {
        return 'App\Modules\Informasi\Veteriner\AlurPersyaratan\Views\_search_list';
    }
}
