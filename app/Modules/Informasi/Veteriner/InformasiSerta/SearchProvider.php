...
use App\Modules\Informasi\Veteriner\InformasiSerta\Models\InformasiSertaModel;

class SearchProvider extends InformasiSertaModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('InformasiSerta.informasiserta');
    }
    ...
    {
        return ADMIN_AREA . '/informasiserta';
    }
    ...
    {
        return 'App\Modules\Informasi\Veteriner\InformasiSerta\Views\_search_list';
    }
}
