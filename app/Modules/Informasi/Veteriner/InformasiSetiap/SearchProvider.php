...
use App\Modules\Informasi\Veteriner\InformasiSetiap\Models\InformasiSetiapModel;

class SearchProvider extends InformasiSetiapModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('InformasiSetiap.informasisetiap');
    }
    ...
    {
        return ADMIN_AREA . '/informasisetiap';
    }
    ...
    {
        return 'App\Modules\Informasi\Veteriner\InformasiSetiap\Views\_search_list';
    }
}
