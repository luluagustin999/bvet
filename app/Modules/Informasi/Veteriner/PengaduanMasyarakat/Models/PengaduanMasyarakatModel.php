...
namespace App\Modules\Informasi\Veteriner\PengaduanMasyarakat\Models;
...
class PengaduanMasyarakatModel extends Model
{
  ...
  public function __construct()
  {
    ...
    $this->validationRules = [
      ...
      'title'    => [
        'label' => lang('PengaduanMasyarakat.title'),
   ...
   */
  public function newPengaduanMasyarakat(): object
  {
    $pengaduanmasyarakat = new stdClass();
    foreach ($this->allowedFields as $field) {
      $pengaduanmasyarakat->$field = null;
    }
    return $pengaduanmasyarakat;
  }
}
