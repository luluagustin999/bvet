...
use App\Modules\Informasi\Veteriner\SertifikatHasil\Models\SertifikatHasilModel;

class SearchProvider extends SertifikatHasilModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('SertifikatHasil.sertifikathasil');
    }
    ...
    {
        return ADMIN_AREA . '/sertifikathasil';
    }
    ...
    {
        return 'App\Modules\Informasi\Veteriner\SertifikatHasil\Views\_search_list';
    }
}
