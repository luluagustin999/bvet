...
use App\Modules\Informasi\Umum\Pelayanan\Models\PelayananModel;

class SearchProvider extends PelayananModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('Pelayanan.pelayanan');
    }
    ...
    {
        return 'App\Modules\Informasi\Umum\Pelayanan\Views\_search_list';
    }
}
