...
use App\Modules\Informasi\Umum\ExternalLink\Models\ExternalLinkModel;

class SearchProvider extends ExternalLinkModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('ExternalLink.externallink');
    }
    ...
    {
        return ADMIN_AREA . '/externallink';
    }
    ...
    {
        return 'App\Modules\Informasi\Umum\ExternalLink\Views\_search_list';
    }
}
