...
use App\Modules\Informasi\Umum\Gallery\Models\GalleryModel;

class SearchProvider extends GalleryModel implements SearchProviderInterface
{
    /**
    ...
    {
        return 'App\Modules\Informasi\Umum\Gallery\Views\_search_list';
    }
}
