...
use App\Modules\Informasi\Umum\Publikasi\Models\PublikasiModel;

class SearchProvider extends PublikasiModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('Publikasi.publikasi');
    }
    ...
    {
        return 'App\Modules\Informasi\Umum\Publikasi\Views\_search_list';
    }
}
