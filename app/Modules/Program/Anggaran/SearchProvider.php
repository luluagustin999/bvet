...
use App\Modules\Program\Anggaran\Models\AnggaranModel;

class SearchProvider extends AnggaranModel implements SearchProviderInterface
{
    /**
    ...
    {
        return 'App\Modules\Program\Anggaran\Views\_search_list';
    }
}
