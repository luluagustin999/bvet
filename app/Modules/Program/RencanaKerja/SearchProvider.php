...
use App\Modules\Program\RencanaKerja\Models\RencanaKerjaModel;

class SearchProvider extends RencanaKerjaModel implements SearchProviderInterface
{
    /**
    ...
    {
        return lang('RencanaKerja.rencanakerja');
    }
    ...
    {
        return ADMIN_AREA . '/rencanakerja';
    }
    ...
    {
        return 'App\Modules\Program\RencanaKerja\Views\_search_list';
    }
}
